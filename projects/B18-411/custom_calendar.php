<?php
$your_google_calendar =
    'https://calendar.google.com/calendar/embed?src=6omfgn5m3vscfab3qs9pgj7308%40group.calendar.google.com&ctz=America%2FNew_York';
$url = parse_url($your_google_calendar);
$google_domain =
    $url['scheme'] . '://' . $url['host'] . dirname($url['path']) . '/';
